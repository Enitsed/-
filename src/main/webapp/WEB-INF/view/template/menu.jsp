...
<div class="ui attached stackable menu">
	<div class="ui container">
		...
		</a> <a class="item" href="movieInfoList"> <i class="grid layout icon"></i> 영화정보
...
<div class="ui mini modal login_modal">
	...
	<div class="ui center aligned grid message">
		...
		<a class="ui tiny inverted blue button" href="findId"><i class="help circle icon"></i>아이디 찾기</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="ui tiny inverted blue button" href="findPw"><i class="help circle icon"></i>비밀번호 찾기</a>
	</div>
</div>
