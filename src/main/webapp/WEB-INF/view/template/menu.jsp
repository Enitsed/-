...
<div class="ui mini modal login_modal">
	...
	<div class="ui center aligned grid message">
		...
		<a class="ui tiny inverted blue button" href="test"><i
			class="help circle icon"></i>아이디 찾기</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
			class="ui tiny inverted blue button" href="test2"><i
...
<div class="ui tiny modal findIdStatus">
	<i class="close icon"></i>
	<div class="ui header">아이디 찾기</div>
	<div class="actions">
		<div class="ui tiny green button">닫기</div>
	</div>
</div>
...
<div class="ui tiny modal findPwStatus">
	<i class="close icon"></i>
	<div class="ui header">비밀번호 찾기</div>
	<div class="actions">
		<div class="ui tiny green button">닫기</div>
	</div>
</div>
