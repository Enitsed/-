...
public class MovieApi {
	public MovieDTO insertMovie(String name) {
		...
		try {
				StringBuilder urlBuilder = new StringBuilder("http://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_xml.jsp"); /* URL */
				urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")+ "=3B5A8771DFD82ACE945DE21EFF5C23A5E655FADCDF33A75F362C2F26EC8BC6"); /* Service Key */
		...
		try {
			if(movieDto.getMovie_kor_title() == null)
				return null;
			else
				return movieDto;
