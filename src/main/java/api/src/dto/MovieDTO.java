...
public class MovieDTO {
	...
	private ArrayList<directorDTO> movie_director = new ArrayList<>();
	private ArrayList<ActorDTO> movie_actor = new ArrayList<>();
	private String movie_rating;
	private ArrayList<categoryDTO> category = new ArrayList<>();
